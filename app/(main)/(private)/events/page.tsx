  ...
  return (
    <section className="flex flex-col items-center gap-16 animate-fade-in">
      <div className="flex gap-4 items-baseline">
        ...
        <Button
          className="bg-blue-500 hover:bg-blue-400 text-white py-6 duration-500 border-b-4 border-blue-700 hover:border-blue-500 rounded-2xl shadow-accent-foreground text-2xl mask-conic-to-black"
          asChild
        >
      ...
      {events.length > 0 ? (
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          started!
          <Button
            className="bg-blue-500 hover:bg-blue-400 text-white py-6 duration-500 border-b-4 border-blue-700 hover:border-blue-500 rounded-2xl shadow-accent-foreground text-2xl"
            asChild
          >
            <Link href="/events/new">
