...
export default function NoTimeSlots({
  ...
  return (
    <Card className="max-w-md mx-auto border-4 border-blue-500/10 shadow-2xl transition delay-150 duration-500 ease-in-out hover:-translate-y-1">
      <CardHeader>
        <CardTitle>
